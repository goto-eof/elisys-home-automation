...
for [**Elisys ESP32 Motion Detector (Rust)**](https://github.com/goto-eof/esp32-motion-detector-and-server-notifier-rust)
and [**Elisys ESP32 Weather Station (Rust)**](https://github.com/goto-eof/elisys-esp32-weather-station-client-rust) projects. Currently, Elisys Home Automation supports the motion sensor and the temperature/humidity/pressure sensor, so that it allows to retrieve the
